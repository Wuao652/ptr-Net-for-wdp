...
def collect_samples_2(instances, instances_units, out_dir, rng, n_samples, node_record_prob):
    i = 0
    i_instance = 0
...
if __name__ == '__main__':
    ...
    collect_samples_2(instances, instances_units, '{}'.format(out_dir), rng, size, node_record_prob)
